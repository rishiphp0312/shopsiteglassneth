...
<!-- end of code-->
							...
							<div class="whiteinsidebox">
								...
								<div class="rightimgbox"><a href="http://{$add_this_name_www}.{if $smarty.server.HTTP_HOST=='www.nethaat.com'}{$details_ofuser_information.username}.{/if}{$add_this_name}/featured_store_information.php"><img src="{$baseUrl}getthumb.php?w=50&h=50&fromfile=uploads/{$v_store_image}" alt="" border="0" class="rightimg" onerror="this.src='{$baseUrl}images/imagsamll.jpg'; this.style.width='50px'; this.style.height='50px';" /></a></div>
