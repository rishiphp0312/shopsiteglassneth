...
//echo 'mail='.$mail_i;
$user_pass_url	= '';
$tbl_msg= "<table align='center'   cellpadding='4' width='100%' bgcolor='#cccccc' cellspacing='0' border='6' bordercolor='#cccccc' >";
$tbl_msg .= "<tr><td>&nbsp;</td></tr>";
...
//if(count($product_1)>0 && count($product_2)>0 && count($product_3)>0)
	...
	if(count($product_1)>0)
$tbl_msg .="<tr><td  colspan='2' bgcolor='#ECF9FF' style='font-family:Verdana, Arial, Helvetica, sans-serif;font-size:20px;font-weight:bold;color:#80D6FF;text-align:center;' >".$heading1."</td></tr><tr>
...
$tbl_msg .="<tr bgcolor='#ffffff'><td colspan='2' style='border:1px solid #ECF9FF;'  valign='top' align='left' ><table bgcolor='#cccccc' align='center' cellpadding='0' cellspacing='0' width='99%' border='0' >";
...
$tbl_msg .="<td valign='top'  align='left' $colspan ><table align='left' border='0' cellpadding='3' cellspacing='0'>
...
$tbl_msg .="<tr><td colspan='2'   valign='top' bgcolor='#ECF9FF' style='font-family:Verdana, Arial, Helvetica, sans-serif;font-size:20px;font-weight:bold;color:#80D6FF;text-align:center;'  align='left'>".$heading2."</td></tr><tr>
...
$tbl_msg .="<tr bgcolor='#ffffff'><td colspan='2'  valign='top' align='left' style='border:1px solid #ECF9FF;'   ><table bgcolor='#cccccc' align='center' cellpadding='0' cellspacing='0' width='99%' border='0' >";
$tbl_msg .="<tr bgcolor='#ffffff'>";
...
$tbl_msg .="<tr ><td valign='top' bgcolor='#ffffff' colspan='2'  align='left'>&nbsp;</td></tr>";
$tbl_msg .="<tr><td colspan='2' valign='top' bgcolor='#ECF9FF'style='font-family:Verdana, Arial, Helvetica, sans-serif;font-size:20px;font-weight:bold;color:#80D6FF;text-align:center;'  align='left'>".$heading3."</td></tr><tr>
...
$tbl_msg .="<tr bgcolor='#ffffff'><td valign='top' colspan='2'  align='left'  style='border:1px solid #ECF9FF;' ><table bgcolor='#cccccc' align='center' cellpadding='0' cellspacing='0' width='99%' border='0' >";
$tbl_msg .="<tr bgcolor='#ffffff'>";
...
//wish to unsubscribed for newsletter <a>click here</a> to unsubscribe.
		  ...
		  //  echo $mail_content;	
	$tbl_msg	=   str_replace("#linkClick#","You receive this message because you have subscribed for newsletter. If you wish to unsubscribed for newsletter <a href='".$user_pass_url."'>click here </a> to unsubscribe.",$tbl_msg); 	 
