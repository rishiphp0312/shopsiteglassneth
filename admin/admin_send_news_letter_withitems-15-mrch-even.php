...
echo $total_records_feature    = mysql_num_rows($objResUsers);
...
$pageLink = $pagination->getPageLinks($total_records_feature, $to, $url, $pageNumber,'', $showPrevNext);
...
$objResItem = $objNewsLetter->selectNewsLetter();
...
$tbl_msg= "<table align='center'  cellpadding='2' width='100%' bgcolor='#cccccc' cellspacing='0' border='0' >";
	if(count($product_1)>0)
$tbl_msg .="<tr><td bgcolor='#ffffff' style='font-family:Verdana, Arial, Helvetica, sans-serif;font-size:18px;font-weight:bold;color:#80D6FF;text-align:left;' >".$heading1."</td>
<td bgcolor='#ffffff' style='font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;font-weight:500;color:#000000;text-align:left;' width='50%' >".$text1."</td>
</tr>";
