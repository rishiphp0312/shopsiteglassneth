...
//$this_script = 'http://localhost/nethaat/paypal-direct.php';
$this_script = 'http://www.flexsin.org/lab/net_haat/paypal-direct.php';
...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
	  ...
	  $bus_id = "pravee_1284618448_biz@seologistics.com";
	//  $bus_id = "pravee_1284618448_biz@seologistics.com";
   ...
   case 'success':      // Order was successful...
	 ...
	 // print_r($_POST);
	//  exit;
       //header("location: http://localhost/nethaat/paytest.php");
      	$this_script = 'http://www.flexsin.org/lab/net_haat/paytest.php';
   ...
   case 'cancel':       // Order was canceled...
        ...
        //   header("location: http://localhost/nethaat/paytest-failed.php");
      	$this_script = 'http://www.flexsin.org/lab/net_haat/api_error1.php';
		header("location: $this_script");
		exit();
