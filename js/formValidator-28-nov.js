...
$(document).ready(function()
{
	...
	$('.only_numericwithfloat').numeric({allow:"."})
  ...
  $("#frm_buynow_quantity").bind("invalid-form.validate", function(e, validator) {
                //hide update msg div
		   if($("#update_msg"))
				{
					$("#update_msg").hide();
			       ...
			       messages: {
					     requested_quantity:{
							 required:" Quantity can not be left blank.",
                                                         numberDE: "Please enter valid value."
						 	 }
         ...
         $("#frm_haat_price_fun").bind("invalid-form.validate", function(e, validator) {
                //hide update msg div
		   if($("#update_msg"))
				{
					$("#update_msg").hide();
				...
				rules: {
			       ...
			       messages: {
					      bid_value: {
							 required:" Haating Price can not be left blank.",
	 ...
	 $("#frmgenrate_ticket").bind("invalid-form.validate", function(e, validator) {									
                ...
                $("#frmpayment_for_standrd").bind("invalid-form.validate", function(e, validator) {									
                //hide update msg div
				if($("#update_msg"))
				{
					$("#update_msg").hide();
				...
				rules: {  
					...
					messages: {  
							title: {  
								 ...
								 ,
                                                      description:{
								 required:"Item Detail can not be left blank."
							          },
                                                      care:{
								required:"Care can not be left blank."
                                                                     },
                                                       materials:{
								 required:"Item Contents can not be left blank."
                                                                     },
