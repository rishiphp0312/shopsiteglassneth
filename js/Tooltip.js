...
{ var isInit = -1;
 ...
 //alert(newPosx+'  newPosy='+window.pageYOffset);
// alert(newPosx+'else  newPosy='+newPosy);
//alert(newPosy+'id  newPosyaddvalue='+window.pageYOffset);
   ...
   { newPosy= newPosy+ document.body.scrollTop;
    ...
    // newPosy= newPosy+630;
    // alert(newPosy+'else  newPosyaddvalue='+document.body.scrollTop);
  ...
  { a = document.getElementById(a);
   ...
   setTimeout( "ToolTip.animate('"+a.id+"',"+iHeight+","+iWidth+")",1000);
    }
