...
{ //echo 'if==ama';
   ...
   $_SESSION['total_paypal_cost_item']=(($d_cost_item*$_SESSION['ship_quantity'])+$shipp_cost);
}else
{ $_SESSION['total_paypal_cost_item']='';
  //echo 'else==a';
  $_SESSION['total_paypal_cost_item']=(($_SESSION['show_d_cost_item']*$_SESSION['ship_quantity'])+$shipp_cost)- ($_SESSION['reciveramount_1_card']+$_SESSION['reciveramount_2_card']);
...
//exit;
 ...
 $str_custom = $last_trans_id.'#|_|#'.$_SESSION['firstcardcode'].'#|_|#'.$shipp_cost.'#|_|#'.$_SESSION['shipping_address1'].'#|_|#'.$_SESSION['shipping_address2'].'#|_|#';
        ...
        $str_custom.= $_SESSION['billing_address1'].'#|_|#'.$_SESSION['billing_address2'].'#|_|#'.$_SESSION['bdest_zip_code'].'#|_|#'.$_SESSION['bcity'].'#|_|#'.$_SESSION['bcountry_value'].'#|_|#'.$_SESSION['sess_requested_quantity'].'#|_|#'.$_SESSION['cost_after_discount'];
			  ...
			  //  $objUser->id         		= $_REQUEST['seller_id'];
				...
				//echo 'paypal-mercht-id'.$paypal_merchant_id;
				//exit;
...
<div style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;text-align:center;">&nbsp;</div>
<div style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;text-align:center;">&nbsp;</div>
<div style="font-family:Arial, Helvetica, sans-serif;font-size:18px;font-weight:bold;text-align:center;">Please wait.....</div>
<div style="font-family:Arial, Helvetica, sans-serif;font-size:18px;font-weight:bold;text-align:center;">You are going to redirect on paypal......</div>
