 ...
 //  echo '<br>';
  ...
  if($num_rows_items1>0)
   ...
   //$recivers_name                      =  $arr_fetch_users_details['name'] ;
	...
	$mail_content		      =  str_replace("#number_days#",'In coming 15 days',$mail_content);
    ...
    echo 'emobj=='.$emailObj->SendHtmlMail('rishi_kapoor@seologistics.com','sending reminder before 15 days',$chek_r,$mailFrom);
