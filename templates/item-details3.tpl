...
<link href="{$baseUrl}magic-zoom/magiczoom.css" rel="stylesheet" type="text/css" />
<script type="text/JavaScript" src="{$baseUrl}magic-zoom/magiczoom.js"></script>
					...
					<div class="iteminsidedetl">
						...
						<div class="itemdtlimgbox">
							<div class="itemsmlimgmain" >	
								...
								<a href="{$baseUrl}uploads/{$users_items_details.image1}" rel="zoom-id:Zoomer;" rev="{$baseUrl}getthumb.php?w=250&h=148&fromfile=uploads/{$users_items_details.image1}" title="{$users_items_details.title}"><img width="70" height="46"  src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image1}"/></a>
								</a>
								</div>
								{/if}
								
								{if $users_items_details.image2!=''}
								<div class="itemsmlimg">									<a href="{$baseUrl}uploads/{$users_items_details.image2}" rel="zoom-id:Zoomer;" rev="{$baseUrl}getthumb.php?w=250&h=148&fromfile=uploads/{$users_items_details.image2}" title="{$users_items_details.title}"><img width="70" height="46"src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image2}"/></a>
								...
								<div class="itemsmlimg">
								<a href="{$baseUrl}uploads/{$users_items_details.image3}" rel="zoom-id:Zoomer;" rev="{$baseUrl}getthumb.php?w=250&h=148&fromfile=uploads/{$users_items_details.image3}" title="{$users_items_details.title}"><img width="70" height="46" src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image3}"/></a>
							...
							<div class="itemsmlimg"><a href="{$baseUrl}uploads/{$users_items_details.image4}" rel="zoom-id:Zoomer;" rev="{$baseUrl}getthumb.php?w=250&h=148&fromfile=uploads/{$users_items_details.image4}" title="{$users_items_details.title}"><img width="70" height="46" src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image4}"/></a>
								
								</div>
								{/if}

								{if $users_items_details.image5!=''}
								<div class="itemsmlimg"><a href="{$baseUrl}uploads/{$users_items_details.image5}" rel="zoom-id:Zoomer;" rev="{$baseUrl}getthumb.php?w=250&h=148&fromfile=uploads/{$users_items_details.image5}" title="{$users_items_details.title}"><img width="70" height="46" src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image5}"/></a>
							...
							<div class="itemdetailimgbox" style='border:0px solid red;padding-left:1px;text-align:center;'>
								...
								{if $users_items_details.image1!=''}
   <a href="{$baseUrl}uploads/{$users_items_details.image1}" class="MagicZoom" id="Zoomer" rel="selectors-effect-speed: 600" title="{$users_items_details.title}">{/if}<img src="{$baseUrl}getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image1}" alt="{$users_items_details.title}" border="0"  />
