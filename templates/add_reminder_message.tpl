...
<div id="middleRtMain">
	<div class="shopmain">
				...
				<div class="clear">
					...
					<div class="titlelf" style='font-weight:bold;text-align:right;' >Message&nbsp;:
							...
							rows='6' cols='50'>{$reminders_details.message}</textarea>
 ...
 -->
						...
						<div  >
							...
							<input type='submit' name='add_value' value='Save' style='width:100px;font-size:12px;font-weight:bold;background-color:#7E354D;border:1px solid #7E354D;cursor:pointer;color:#ffffff;' >&nbsp;&nbsp;<input type='submit' name='send_email' value='Send Email' style='width:100px;font-size:12px;font-weight:bold;background-color:#7E354D;border:1px solid #7E354D;cursor:pointer;color:#ffffff;'>
							</div>
							<div class="clear"></div>
