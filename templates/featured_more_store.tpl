		...
		<tr>
			<td>
				...
				{if $store[featured].v_store_image ne '' }
					...
					<img src='{$baseUrl}getthumb.php?w=150&h=50&fromfile=uploads/store_logos/{$store[featured].v_store_image} 'align="middle" border="1" class="" style="padding:2px;vertical-align:top;">
				{else}
