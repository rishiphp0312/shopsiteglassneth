...
{include file="header_search.tpl"}
		...
		<!--Start Middle-->
			...
			<div id="middleRtMain">
				...
				{if $pageLink}
<div class="bradcrum" 
style="width:710px;float:right;text-align:right;border:0px solid red;">
	...
	<a href="item-details.php?details_item_value={$val_items.item_id}" >{$val_items.title|ucfirst}</a></td></tr>
			 <tr><td align='center' valign='top' class="priceText">Price &nbsp;:&nbsp;<span>
				 {$val_items.cost_item|convert_price} <br>USD {$val_items.cost_item|convert_number} </span></td></tr>
