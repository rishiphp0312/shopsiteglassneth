...
{include file="header_search_banner.tpl"}
...
<!-- end of code-->
							...
							<div class="whiteinsidebox">
								...
								<div class="rightimgbox"><a href="http://{$add_this_name_www}.{if $smarty.server.HTTP_HOST=='www.nethaat.com'}{$details_ofuser_information.username}.{/if}{$add_this_name}/featured_store_information.php"><img src="{$baseUrl}getthumb.php?w=105&h=130&fromfile=uploads/{$details_ofuser_information.username}{if $details_ofuser_information.sel_logo_status==2}/store_logos/{$details_ofuser_information.store_logo}{else}/banners/{$details_ofuser_information.banner_name}{/if}" alt="" border="0"  onerror="this.src='{$baseUrl}images/imagsamll.jpg'; this.style.width='50px'; this.style.height='50px';" /></a></div>
