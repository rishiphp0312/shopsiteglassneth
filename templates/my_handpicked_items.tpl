...
{/literal}
    ...
    <div id="middleRtMain">
     <div class="shopmain"  >
        <div class="mainHD fl" >My Featured Items</div>
	...
	<a href='seller_active_items.php?order_by={$cost_asc}'><img src='images/arrow_top.gif'>
	</a>&nbsp;
	...
	{$quantity_available_asc}'><img src='images/arrow_top.gif'></a>&nbsp;<a href='seller_active_items.php?order_by={$quantity_available_desc}'>
	<img src='images/arrow_btm.gif'></a>
	<!--<br><br>	quantity_available -->
	</div>
	...
	<br><br>
	{if $val_items.hatting_status==0 && $val_items.status!=1} {/if}
	</div>
	...
	{/if}&nbsp;&nbsp;&nbsp;
        ...
        {if $val_items.expired_package ==1  }&nbsp;Package Expired.&nbsp;<br>
         {/if}
        {if $val_items.delete_restored ==1}&nbsp;Item deleted by Admin.&nbsp;<br>
         {/if}
         </span>&nbsp;
	<blink>
	...
	<br>{if $val_items.status!=3}Current Status{/if}<span style="color:red;padding-left:5px;">{if $val_items.status==0}Pending {/if}{if $val_items.status==1}Active {/if}
	...
	{else}
	<div class="itemimgbox" style='color:red;font-size:14px;width:690px;'> No records found!!</span>
	<div class="clear"></div>
	</div>
       {/if}
	<div class="clear"></div>
