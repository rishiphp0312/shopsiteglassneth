...
<a href="add_reminder.php?rem_id_value={$val_items.rem_id}"><img class='vAlign'  src='images/edit_btn.jpg' border='0'>
	</a>
	...
	<br><br>
	<a href="add_reminder_message.php?rem_id_value={$val_items.rem_id}">Save New Message</a>
	<br>
