...
<div id="middleRtMain">
	<div class="shopmain">
				<div class="mainHD fl" >View Haating History</div>
	...
	<div style="width:200px;">
        ...
        <img  src="{if $val_items.image1!=''}{$baseUrl}getthumb.php?w=150&h=50&fromfile=uploads/{$val_items.image1}{else}images/no_img.jpg{/if}" alt="" {if $val_items.image1==''}width='70' height="50"{/if} border='0'  class="itemimg handle" /></a>	<br>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	</span>&nbsp;{$anObject->bid_history($val_items.item_id,$smarty.session.session_user_id) }
	...
	<span class="itemlf" ><span style="color:#CC0033">{*if $val_items.add_date!=''*}{*/if*}</span>
	{if $val_items.add_date!=''} {/if}{*$val_items.add_date|date_format:"%B %d, %Y"*}</span>
	<br></div>
							<div class="clear"></div>
						</div>
