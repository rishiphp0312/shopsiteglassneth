...
<table width="100%"  border="0" cellspacing="10" cellpadding="5">
	...
	<tr>
		...
		<input type='text' style='width:180px;' value='{$arr_qty_value}' id='name'  class="input required"  name='name'></td>
	 </tr>
	 <tr>
		...
		<input type='text' style='width:180px;' value='{$arr_qty_cost_value}' id='email'  class="required email input"  name='email'></td>
	 </tr>
	  <tr>
	        <td align='right' ><b>Amount</b>&nbsp;:</td>
		      
	        <td align='left' style='padding-right:25px;'>
		<input type="text" name="amount" id='amount' style='width:180px;' value='{$arr_qty_cost_value}'
	  ...
	  <tr>
	        ...
	        <td align='left' style='padding-right:25px;'>
		<input type='text' value='{$arr_qty_cost_value}' id='city' style='width:180px;' 
	   ...
	   <tr>
		...
		<td align='left' style='padding-right:25px;'>
		<input  style='width:180px;'  value='{$arr_qty_cost_value}'  type="text" name="state" 
		class="input required ">
	</td>
	 </tr>
	   <tr>
