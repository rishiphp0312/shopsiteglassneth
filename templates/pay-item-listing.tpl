...
<div class="shopmain">
<span class="mainHD">Pay To List Your Item</span>
	<!--Start my items -->
	<div class="myitemmain">
		...
		<tr>
			<td colspan="2">
				...
				<input type=hidden name='id' value="{$custom_item_id}" />
...
<tr>
			<td style="padding-left:25px;width:200px;">Listing  Cost is:<span style="color:red;"></span></td>
			<td><input maxlength=7 name="amount" readonly value="{$smarty.session.session_cost_item}"
		...
		<tr>
			...
			<td>
				<input type="submit" class='Class_Button_ris' name="submit" value="PURCHASE NOW"  />
			</td>
			<td></td>
		</tr>
		</table>
