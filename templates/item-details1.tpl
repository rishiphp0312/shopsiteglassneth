...
<link href="{$baseUrl}zoomla-site/home.css" rel="stylesheet" type="text/css">
<link href="{$baseUrl}zoomla-site/jqzoom.css" rel="stylesheet" type="text/css" />
<link href="{$baseUrl}zoomla-site/global.css" rel="stylesheet" type="text/css" />
<script src="{$baseUrl}zoomla-site/jquery_003.js" type="text/javascript" language="javascript"></script>
<script src="{$baseUrl}zoomla-site/jquery.js" type="text/javascript" language="javascript"></script>
<script src="{$baseUrl}zoomla-site/jquery_002.js" type="text/javascript" language="javascript"></script>

<script src="{$baseUrl}zoomla-site/jqzoom.js" type="text/javascript" language="javascript"></script>
<script type="text/javascript" language="javascript">
{literal}
var moving_item=3; move=0; move_count=0;
$(document).ready(function(){

	$('a.jqzoom').jqzoom();
	$('.zoom-image:eq(0)').css('visibility','visible');
	$('.thumb-image').click(function(){
		$('.zoom-image').css('visibility','hidden');
		$('.zoom-image:eq('+$('.thumb-image').index(this)+')').css('visibility','visible');
	});
	scrollUp();
});
				...
				<div>
					<div class="iteminsidedetl">
						...
						<div class="itemdtlimgbox">
							...
							<img src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image1}" class="thumb-image" alt="YSL muse" width="60">
								...
								<div class="itemsmlimg">											
							<img src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image2}" class="thumb-image" alt="YSL muse" width="60">
								...
								<div class="itemsmlimg">
									<img src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image3}"  class="thumb-image" alt="YSL muse" width="60">
								</div>
								{/if}

								{if $users_items_details.image4!=''}
								<div class="itemsmlimg">
								<img src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image4}" class="thumb-image" alt="YSL muse" width="60">
								</div>
								{/if}

								{if $users_items_details.image5!=''}
								<div class="itemsmlimg">
								<img src="{$baseUrl}getthumb.php?w=70&h=46&fromfile=uploads/{$users_items_details.image5}" class="thumb-image" alt="YSL muse" width="60">
								</div>
								{/if}
																		
							</div>
							<div  class="itemdetailimgbox" style='border:0px solid red;width:400px;padding-left:1px;text-align:center;'> 
							
							<div style="visibility: visible;" class="image zoom-image">
								<a title="" href="{$baseUrl}uploads/{$users_items_details.image1}" class="jqzoom" style="outline-style: none; cursor: crosshair; display: block; position: relative; z-index: 600; height: 300px; width: 300px;"><img title="" style="" src="{$baseUrl}getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image1}" alt="{$users_items_details.title}"  class="zooming-image"></a>
								</div>
								<div style="visibility: hidden;" class="image zoom-image">
								<a title="" href="{$baseUrl}uploads/{$users_items_details.image2}" class="jqzoom" style="outline-style: none; cursor: crosshair; display: block; position: relative; z-index: 600; height: 300px; width: 300px;"><img title="" style="" src="{$baseUrl}getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image2}" alt="{$users_items_details.title}"  class="zooming-image"></a>
								<div class="clr"></div>
                            </div>
							<div style="visibility: hidden;" class="image zoom-image">
								<a title="" href="{$baseUrl}uploads/{$users_items_details.image3}" class="jqzoom" style="outline-style: none; cursor: crosshair; display: block; position: relative; z-index: 600; height: 300px; width: 300px;"><img title="" style="" src="{$baseUrl}getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image3}" alt="{$users_items_details.title}"  class="zooming-image"></a>
								<div class="clr"></div>
                            </div>
							<div style="visibility: hidden;" class="image zoom-image">
								<a title="" href="{$baseUrl}uploads/{$users_items_details.image4}" class="jqzoom" style="outline-style: none; cursor: crosshair; display: block; position: relative; z-index: 600; height: 300px; width: 300px;"><img title="" style="" src="{$baseUrl}getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image4}" alt="{$users_items_details.title}"  class="zooming-image"></a>
								<div class="clr"></div>
                            </div>
							...
							<!--<div class="itemdetailimgbox" style='border:0px solid red;width:400px;padding-left:1px;text-align:center;'>
								...
								{if $users_items_details.image1!=''}
                                                                <a href='getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image1}' class = 'cloud-zoom' id='zoom1' rel="adjustX: 10, adjustY:-4, softFocus:false">
								{/if}
                <img src="{$baseUrl}getthumb.php?w=500&h=296&fromfile=uploads/{$users_items_details.image1}" alt="{$users_items_details.title}"  border="0"  />
