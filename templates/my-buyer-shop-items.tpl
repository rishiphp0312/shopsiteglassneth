...
<a href="featured_store_information.php?id={$val_items.shop_id}"><img  src="{if $val_items.v_store_image!=''}{$baseUrl}getthumb.php?w=150&h=50&fromfile=uploads/{$val_items.v_store_image}{else}images/item_small_img.jpg{/if}" alt="" {if $val_items.v_store_image!=''} height='50' width="100" {/if} border='0'  class="itemimg handle" /></a>
							<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
