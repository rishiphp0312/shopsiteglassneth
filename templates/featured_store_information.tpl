		...
		<div class="clear"></div>
			<div class="buyermain">
				...
				<div class="clear"></div>
					...
					src="{$baseUrl}getthumb.php?w=415&h=120&fromfile=uploads/{$username}/store_logos/{$store_logo}" onerror="this.src='{$baseUrl}images/item_small_img.jpg'; this.style.width='415px'; this.style.height='120px';" alt="" /></div>-->
