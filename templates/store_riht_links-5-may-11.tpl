...
<div class="itemDetialfrmain">
	<div class="rightbox">
		...
		<div class="whiteinsidebox">
			...
			<div class="rightimgbox"><a href="featured_store_information.php?id={$sellerid}"><img src="{$baseUrl}getthumb.php?w=50&h=50&fromfile=uploads/{$v_store_image}" onerror="this.src='{$baseUrl}images/item_small_img.jpg'; this.style.width='50px'; this.style.height='50px';" alt="" border="0" class="rightimg" /></a></div>
