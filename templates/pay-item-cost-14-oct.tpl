...
<span class="mainHD">Buy you Item</span>
	...
	<div class="myitemmain">
		...
		<form action="pay-item-cost.php" method="post" name="frmpayment" id="frmpayment">
		...
		<tr>
			...
			<td align="left" valign="top">
				...
				value="{$user_values.address1}" class="formInput required  alph_num_space" ></td>
			<td align="left" valign="top"></td>
		</tr>
		<tr>
			<td align="left" valign="top" style="padding-left:25px;width:200px;">Address 2:<span style="color:red;"></span></td>
			<td align="left" valign="top">
				<input type="text" maxlength=100 name="address2" value="{$user_values.address2}" class="formInput  required  alph_num_space" >			</td>
		...
		<tr align="left" valign="top">
			...
			<td align="left"><b>{$USD}&nbsp;{$smarty.session.d_cost_item|trim:'-'}&nbsp;</b></td>
			<td>&nbsp;</td>
		</tr>
