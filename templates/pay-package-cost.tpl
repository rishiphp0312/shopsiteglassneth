...
<div class="shopmain">
<span class="mainHD">Buy Package</span>
	<!--Start my items -->
	<div class="myitemmain">
		...
		<tr align="left" valign="top">
			...
			<td><input maxlength='7' name="amount" readonly value="{$smarty.post.amount}"
			class="formInput"  /></td>
       		<td align='left' ><b>{$USD}</b>&nbsp;
                <input type='hidden' value='{$duration_id}' name='duration_id'>
                <input type='hidden' value='{$package_max_items}' name='max_items'>
                <input type='hidden' value='{$package_min_items}' name='min_items'>
                <input type='hidden' value='{$package_name_id}' name='package_name_id'>
                </td>
		</tr>
