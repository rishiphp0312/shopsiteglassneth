...
{include file="header_search.tpl"}
		...
		<!--Start Middle-->
			...
			<div id="middleRtMain">
				...
				<!--start page number -->
				{if $pageLink}
				<div class="bradcrum" style="width:710px;float:right;text-align:right;
				border:0px solid red;">
		<table align='center' width='100%' cellpadding='0' cellspacing='0' border='0'>
		
		<tr><td align='left' valign='middle' width='30%' style="text-align:left;" >
					{*$page_counter*}  <!--items.-->&nbsp;&nbsp;&nbsp;</td>
				...
				<!--end page number -->
				<div class="clear"></div>
					<div class="buyermain" align='center' >
					{if $no_records>0}
				...
				<table align='center' cellpadding='0'  cellspacing='3'width='127px;' border='0' >
					<tr><td colspan='4'>&nbsp;</td></tr>
                     <tr>
                      ...
                      <img src="{$baseUrl}getthumb.php?w=150&h=100&fromfile={if $val_items.image1!=''}uploads/{$val_items.image1}{else}images/item_small_img.jpg{/if}"
			  alt="" border="0" class="buyerimg"  /></a></td></tr>
			 <tr><td align='center' valign='top' height="20" class="productNme">
	<a href="item-details.php?details_item_value={$val_items.item_id}" >
{assign var='tit_trunc' value = $val_items.title|truncate:20:"":true}{$tit_trunc|ucfirst}
</a></td></tr>
			 <tr><td align='center' valign='top'  class="priceText">Price &nbsp;:&nbsp;<span>
				<!-- {$USD}-->&nbsp;{$val_items.cost_item|convert_price}</span></td></tr>
	...
	<table align='center' cellpadding='0'  cellspacing='0' width='127px;' border='0' >
		...
		<td align='right' valign='top'><span class="detailfr"><a href="item-details.php?details_item_value={$val_items.item_id}" >
