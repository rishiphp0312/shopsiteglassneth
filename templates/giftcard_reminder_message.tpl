	...
	<div class="shopmain">
				...
				<div class="clear">
					...
					<form name="frmgenrate_coupon" id='frmgenrate_coupon' action='' method='post' >
						...
						<div  >
					<div class="titlelf" style='font-weight:bold;text-align:right;' valign='top'>Message&nbsp;:
							</div>
							
							<div class="itemlf" >
				<textarea name='message' class='required' id='message' rows='6' cols='50'>{$reminders_details.message}</textarea>
			<!--<input type='hidden' value='{$rem_id_value}' name='rem_id_value'>-->
							...
							<div class="costlf" >
							<input type="hidden" value="{$giftcard_cost}" name="giftcard_cost" />&nbsp;<input type="hidden" value="{$giftcard_code}" name="giftcard_code" /></div>
							<div class="clear"></div>
						...
						<div  >
							...
							<div class="costlf" style='width:480px;text-align:left;padding-top:5px;' ><input type='submit' name='add_value' value='Save' style='width:100px;font-size:12px;font-weight:bold;background-color:#7E354D;border:1px solid #7E354D;cursor:pointer;color:#ffffff;'>&nbsp;&nbsp;<input type='submit' name='send_email' value='Send Email' style='width:100px;font-size:12px;font-weight:bold;background-color:#7E354D;border:1px solid #7E354D;cursor:pointer;color:#ffffff;' >
							</div>
							<div class="clear"></div>
