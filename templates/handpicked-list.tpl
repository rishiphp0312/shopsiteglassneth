...
{include file="header_search.tpl"}
		...
		<!--Start Middle-->
			...
			<div id="middleRtMain">
				...
				<!--start page number -->
				{if $pageLink}
				<div class="bradcrum" style="width:600px;float:right;text-align:right;border:0px solid red;">
		  ...
		  {/if}
				<table align='center' cellpadding='0'  cellspacing='0' 
					...
					<tr><td colspan='4'>&nbsp;	
                          ...
                          <tr><td align='center' valign='top'><a href="item-details.php?details_item_value={$val_items.item_id}" ><img src="{if $val_items.image1!=''}{$baseUrl}getthumb.php?w=150&h=50&fromfile=uploads/{$val_items.image1}{else}images/no_img.jpg{/if}" alt="" border="0" class="buyerimg"  /></a></td></tr>
	...
	<a href="item-details.php?details_item_value={$val_items.item_id}" >{$val_items.title|ucfirst}</a></td></tr>
			 <tr><td align='center' valign='top' class="priceText">Price &nbsp;:&nbsp;<span>
				 {$USD}&nbsp;{$val_items.cost_item|number_format:2:".":","}   </span></td></tr>
				   <tr><td align='left' valign='top' >
				 <table align='center' cellpadding='0'  cellspacing='0' width='140px;' border='0' >
					<tr>
					<td align='left' valign='top' class="buynow">
			<a href="#item-details.php?details_item_value={$val_items.item_id}" ><img src="images/buy_bow_icon.jpg" alt="" border="0" /></a>
						<a href="#details.php?item_id={$val_items.item_id}"> Buy now</a></td>
			...
			<a href="item-details.php?details_item_value={$val_items.item_id}" ><img src="images/details_btn.jpg" alt="" border="0" /></a></span>
				...
				{/foreach}
					...
					<div class="buyerimgbox">
						...
						<div class="productNme"><a href="#">Product Name</a></div>
						<div class="priceText">Price: <span>$43.00</span></div>
						<div class="buynow"><a href="#"><img src="images/buy_bow_icon.jpg" alt="" border="0" /></a><a href="#"> Buy now</a></div>
						<div class="detailfr"><a href="#"><img src="images/details_btn.jpg" alt="" border="0" /></a></div>
						<div class="clear"></div>
					  </div>
					<div class="buyerimgbox">
