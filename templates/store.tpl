	...
	<div id="middleMain">
			<div>
				...
				<!--	<div class="field">City:<span class="redClr">*</span></div>
					...
					<div class="labal">
<input type="text" name="zipcode" class="formInput required" maxlength="20" value="{$zipcode|clear_input}" />
</div>
					<div class="clr"><img src="images/spacer.gif" height="1" width="1" /></div>
...
<div class="labal"><input type="text" name="paypal_merchant_id"class="formInput required email" maxlength="60" value="{$paypal_email|clear_input}" /></div>
<div class="clr"><img src="images/spacer.gif" height="1" width="1" /></div>
-->
		{if $value_of_country==1}
		<!--<div  style="width:600px;border:0px solid red;">
				<div class="field">Select Payment&nbsp;:</div>
					<div class="labal">&nbsp;&nbsp;Paypal Details&nbsp;
&nbsp;<input type="radio" value="0" {if $payment_type==0 ||$payment_type==''}
checked="checked"{/if}  onClick="return show_rows(1)"  name="choose_payment"/>
&nbsp;&nbsp;CC Avenue&nbsp;&nbsp;<input type="radio" value="1" {if $payment_type==1}
checked="checked"{/if}  onClick="return show_rows(2)" name="choose_payment"/></div>
					<div class="clr"><img src="images/spacer.gif"
height="1" width="1" /></div> </div>-->{/if}
<!--
<div id="row_user" style="width:600px;border:0px solid red;{if $payment_type==1}display:none;{/if}">
					...
					<div class="clr">
<img src="images/spacer.gif" height="1" width="1" /></div>
</div>
...
<div id="row_sign" style="width:600px;border:0px solid red;{if $payment_type==1}display:none;{/if}">
					...
					<div class="field">PayPal Merchant Id:</div>
					<div class="labal">
<input type="text" name="paypal_merchant_id" class="formInput" maxlength="60"
value="{$paypal_merchant_id}" />&nbsp;&nbsp;(Standard Paypal)</div>
					<div class="clr"><img src="images/spacer.gif" height="1" width="1" />
					</div>
</div>
...
<div id="row_merchant_id" style="width:600px;border:0px solid red;{if $payment_type==0 || $payment_type==''}display:none;{/if} ">
		...
		<div class="field" >CC Avenue Merchant Id:</div>
					...
					<div class="clr">
<img src="images/spacer.gif" height="1" width="1" /></div></div>
<div>Payment for our service is made through Pay Pal. If you do not
 already have a Pay Pal account, you must sign up for one using the email
 address you enter here in the next step.<br /><br /></div>-->
