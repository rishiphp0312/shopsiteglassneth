<?php
// email notification for sending reminder before 2 day from event
...
// done-linux
 ...
 //for($i=1;$i<=15;$i++)
   ...
   if($num_rows_items1>0)
	...
	{
    //    $item_values_list_emails[]         = $arr_items_array['email_id_grp'];
	...
	$mail_content			              =  str_replace("#number_days#",'Today',$mail_content);
    ...
    <td align='left'>Event Name</td><td  align='left'>Name</td><td align='left'>Date of Event</td>
    </tr>";
   ...
   $message .="</table>";
    ...
    echo 'emobj=='.$emailObj->SendHtmlMail('rishi_kapoor@seologistics.com','sending message with giftcards before 2 days of occasion',$chek_r,$mailFrom);
