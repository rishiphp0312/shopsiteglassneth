...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	?>
<?php
/****************************** START auto login functionality ******************************************/
/**
*@Created By : Mahipal Adhikari
*@Created On : 10-Dec-09
*@Description: create auto login functionality for blog admin,
*				admin needs to login on Kauai admin panel to manage blogs
**/
...
else
{
		...
		if(add_action('init', 'auto_login'))
		{
			wp_redirect("wp-admin/index.php");
			exit();
		}
}
/****************************** END auto login functionality ******************************************/
?>	
