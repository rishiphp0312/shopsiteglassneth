...
<body>
    ...
    <table class="api">
        ...
        <tr>
				...
				<td>
					<input type="text" name="L_AMT1" size="5" maxlength="32" value="39.70" /> </td>
			 ...
			 <tr>
				...
				<td class="field">
					Amount: <br /> </td>
				<td>
					<input type="text" name="L_AMT0" size="5" maxlength="32" value="9.95"  /> </td>
       ...
       <th>Buyers Details:</th>
		...
		<tr>
			<td class="field">
				Country:</td>
			<td>
				<input type="text" size="30" maxlength="32" name="SHIPTOCOUNTRYCODE" value="USA" /></td>
		</tr>
		<tr>
			<td class="field">
				Zip Code:</td>
