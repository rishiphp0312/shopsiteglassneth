...
if($_SERVER['REQUEST_METHOD']=='POST' && $_POST['send_email']!='')
	...
	$mail_content			              =  str_replace("#table_str#",'',$mail_content);
...
// Creating object of SendEmailClass
   ...
   success_msg("Your messgae has been successfully sent !!");	
		...
		if($error_msg=="")
				{
					 $emailObj 	         = new SendEmailClass;
					  ...
					  success_msg("Message is  successfully added !!");	
				  }
		else
				{
...
//display template
$smarty->assign('site_page_title','Nethaat :  Add Reminder Message');
$smarty->assign('site_title',$site_title);
$smarty->display('add_reminder_message.tpl');
?>
