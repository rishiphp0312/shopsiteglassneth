...
/// end of email notification
		   ...
		   if($num_rows_BIDLIMIT_value>0)
			...
			else
			{
                ...
                //echo 'sellers_number_of_items1=='.$sellers_number_of_items1;
               if($sellers_number_of_items1>=5)
               $visble_val = 5;
               else
               $visble_val = $sellers_number_of_items1;
                //$visble_val = 2;
                //echo $sellers_number_of_items1;
...
//display template
$smarty->assign('site_page_title','Nethaat: Item Details');
$smarty->assign('site_title',$site_title);
$smarty->display('item-details.tpl'); 
?>