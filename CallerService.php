...
// mail('rishi_kapoor@seologistics.com','hi','how r u');
//$API_UserName=API_USERNAME;
//$API_UserName='mahipa_1264403145_biz_api1.seologistics.com';
//$API_UserName='sdk-three_api1.sdk.com';
$API_UserName=$_SESSION['API_USERNAME'];

//$API_Password=API_PASSWORD;
//$API_Password= '1264403151';
$API_Password= $_SESSION['API_PASSWORD'];


//$API_Signature=API_SIGNATURE;
//$API_Signature='AFcWxV21C7fd0v3bYYYRCpSSRl31Ayl.txyiOgz5NznCRbbSTgxEyql-';
$API_Signature=$_SESSION['API_SIGNATURE'];
...
function hash_call($methodName,$nvpStr)
{
   ...
   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php
	...
	$response = curl_exec($ch);
        //mail('rishi_kapoor@seologistics.com','hi','how r u'.$response);
