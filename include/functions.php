...
function getIPAdressInfomation($userip)
{
	...
	$url = file_get_contents("http://s.site90.com/api/xml.php?type=ip&ip=".$userip);
	//print $xml_resp;
        $ch = curl_init($url);
...
function getIPAdressInfomation($userip)
{//$userip= '203.122.51.28';
//echo 'xcxcx'.$userip;
//echo '<br>';
//IN
	//set default country code if API fails
	$country_code = "US";
        $url="http://api.ipinfodb.com/v2/ip_query.php?key=936462656b47c77cd8ffe6c5e232d4d4757957ab25631592578ace0eae293ea6&ip=$userip&timezone=false";
...
//	print "<pre>";
 ...
 //echo 'user-ip'.$userip; echo 'remote'.$_SERVER['REMOTE_ADDR'];
	//set default country code if API fails
	//$country_code = "US";
         // $key_ip  = '936462656b47c77cd8ffe6c5e232d4d4757957ab25631592578ace0eae293ea6';
	//  $url = "http://api.ipinfodb.com/v2/ip_query.php?key=".$key_ip."&ip=".$userip."&timezone=false";

	//$url = "http://ipinfodb.com/ip_query.php?ip=".$userip."&timezone=false";
	//$url="http://www.geobytes.com/IpLocator.htm?GetLocation&IpAddress=".$userip;
	//$url="http://api.ipinfodb.com/v2/ip_query.php?key=936462656b47c77cd8ffe6c5e232d4d4757957ab25631592578ace0eae293ea6&ip=".$userip."&timezone=false";
	//$ch = curl_init($url);
//	curl_setopt($ch, CURLOPT_HEADER, 0);
