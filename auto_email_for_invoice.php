...
$baseUrl2= "http://www.nethaat.com/commision_items_listing.php";
...
// done-linux
        ...
        while($arr_user_Invoicedetails  = mysql_fetch_assoc($get_Invoicedetails))
          {
            ...
            //if($num_invoicedetails>0)
              ...
              $message .="<tr><td colspan='4'><a href='".$baseUrl2."'>click here to pay commision</a></td>
			</tr></table>";
			...
			//$emailObj->SendHtmlMail($to_email_id,$subject,$mail_content,$mailFrom);
  ...
  echo 'emobj=='.$emailObj->SendHtmlMail('rishi_kapoor@seologistics.com','file set on 1 and 15 Email Invoice-daysbefore',$chek_r,$mailFrom);
   //echo $mail_content;
          //echo '<br>';
